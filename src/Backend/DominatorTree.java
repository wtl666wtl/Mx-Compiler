...
public class DominatorTree {
    ...
    public HashMap<Block, Block> minVertex = new HashMap<>();
    ...
    public Block eval(Block it){
        ...
        if(union.get(it) != union.get(union.get(it))){
            if(dfsOrder.get(sDom.get(minVertex.get(it))) > dfsOrder.get(sDom.get(eval(union.get(it)))))
                minVertex.put(it, eval(union.get(it)));
            union.put(it, union.get(union.get(it)));
        }
        return minVertex.get(it);
    }
